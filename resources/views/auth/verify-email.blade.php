    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white border border-gray-200 p-8 rounded-lg shadow-lg max-w-md w-full mx-4 sm:mx-auto text-center">
            ...
            <form method="POST" action="{{ route('send.otp') }}" class="space-y-4">
                ...
                <div class="mb-6">
                    {!! htmlFormSnippet(['callback' => 'enableSubmit']) !!}
                ...
                <button
                    ...
                    id="submitBtn"
                    disabled
                    class="w-full px-4 py-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm text-center disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Send OTP
                </button>
            </form>
