        ...
        <div class="w-full lg:w-1/3 flex flex-col space-y-8">
            <div class="flex flex-col items-start p-4 bg-white shadow-md rounded-lg space-y-4 h-full">
                ...
                <div class="flex space-x-2">
                    ...
                    <span class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg shadow">Good for any type of Events</span>
                </div>
            </div>
            ...
            <div class="p-4 bg-white shadow-md rounded-lg">
                ...
                <p class="text-gray-700">Valid for up to 4 hours usage only. Additional charge is applied for each succeeding hour. </p>
            </div>
