                    ...
                    <div>
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input id="checkin" name="checkin" type="date"
                                   ...
                                   class="bg-white bg-opacity-80 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full ps-10 p-2.5"
                                   required>
                        </div>
                    </div>
