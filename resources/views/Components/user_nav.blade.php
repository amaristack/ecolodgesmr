    ...
    <nav class="border-gray-200 shadow-lg">
        <div class="flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        ...
                        <li>
                            <a href="/profile/password/{{ $user->id }}/edit"
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul class="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 font-bold dark:border-gray-700">
                    <li>
                    ...
                    <li>
                        <x-nav_design href="/function-hall" :active="request()->is('function-hall')">Function Hall</x-nav_design>
                    </li>
                </ul>
            </div>
